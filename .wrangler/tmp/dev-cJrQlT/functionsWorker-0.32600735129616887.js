...
// .wrangler/tmp/bundle-Bm602t/checked-fetch.js
...
// .wrangler/tmp/pages-ppjHxe/functionsWorker-0.32600735129616887.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-JHOEi1/checked-fetch.js"() {
    "use strict";
...
var init_email_notifications = __esm({
  "api/auth/shared/email-notifications.ts"() {
    "use strict";
    init_functionsRoutes_0_5582200618020116();
    init_checked_fetch();
...
function createTimeBucket(timestamp, minutesPerBucket) {
  const year = timestamp.getFullYear();
  const month = String(timestamp.getMonth() + 1).padStart(2, "0");
  const day = String(timestamp.getDate()).padStart(2, "0");
  const totalMinutes = timestamp.getHours() * 60 + timestamp.getMinutes();
  const bucketMinutes = Math.floor(totalMinutes / minutesPerBucket) * minutesPerBucket;
...
function processHeartbeatData(network, data) {
  ...
  heartbeats.forEach((heartbeat) => {
    ...
    const bucketKey = createTimeBucket(timestamp, 5);
...
var routes;
var init_functionsRoutes_0_5582200618020116 = __esm({
  "../.wrangler/tmp/pages-ppjHxe/functionsRoutes-0.5582200618020116.mjs"() {
    "use strict";
    init_callback();
    init_callback2();
    init_callback3();
...
// .wrangler/tmp/bundle-Bm602t/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Bm602t/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.32600735129616887.js.map
