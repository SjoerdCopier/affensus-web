...
// .wrangler/tmp/bundle-kirAI1/checked-fetch.js
...
// .wrangler/tmp/pages-UeGO2c/functionsWorker-0.12417482241186761.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-tawp1G/checked-fetch.js"() {
    "use strict";
...
var init_email_notifications = __esm({
  "api/auth/shared/email-notifications.ts"() {
    "use strict";
    init_functionsRoutes_0_12923225273795336();
    init_checked_fetch();
...
async function fetchStatusPageData(networkName) {
  try {
...
async function processPrometheusMetrics(metricsText) {
  ...
  for (const domain of domains.values()) {
    ...
    if (statusPageData && statusPageData.heartbeatList && Object.keys(statusPageData.heartbeatList).length > 0) {
      ...
      domain.urls.forEach((url) => {
        ...
        Object.values(statusPageData.heartbeatList).forEach((heartbeatArray, index) => {
          console.log(`Monitor ${index} heartbeats:`, Array.isArray(heartbeatArray) ? heartbeatArray.length : "not array");
          if (Array.isArray(heartbeatArray)) {
            allHeartbeats.push(...heartbeatArray);
          }
        });
        console.log(`Total heartbeats collected for ${domain.domain}:`, allHeartbeats.length);
        ...
        if (url.heartbeats.length > 0) {
          console.log(`Sample heartbeat:`, url.heartbeats[0]);
        }
      });
...
var routes;
var init_functionsRoutes_0_12923225273795336 = __esm({
  "../.wrangler/tmp/pages-UeGO2c/functionsRoutes-0.12923225273795336.mjs"() {
    "use strict";
    init_callback();
    init_callback2();
    init_callback3();
...
// .wrangler/tmp/bundle-kirAI1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kirAI1/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.12417482241186761.js.map
