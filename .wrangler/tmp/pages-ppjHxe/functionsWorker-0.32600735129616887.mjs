...
// ../.wrangler/tmp/bundle-UJntIu/checked-fetch.js
...
function processHeartbeatData(network, data) {
  ...
  heartbeats.forEach((heartbeat) => {
    ...
    const bucketKey = createTimeBucket(timestamp, 1);
...
// ../.wrangler/tmp/bundle-UJntIu/middleware-loader.entry.ts
init_functionsRoutes_0_5582200618020116();
init_checked_fetch();

// ../.wrangler/tmp/bundle-UJntIu/middleware-insertion-facade.js
init_functionsRoutes_0_5582200618020116();
init_checked_fetch();
...
//# sourceMappingURL=functionsWorker-0.32600735129616887.mjs.map
