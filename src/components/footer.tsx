      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.linkedin.com/in/sjoerd-copier-05280114/" className="text-gray-400 hover:text-white transition-colors">
                <span className="sr-only">{t('footer.socialMedia.linkedin')}</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href={getLocalizedPath('/refund-policy')} className="text-white inline-flex items-center text-sm font-medium leading-none border-b border-dotted border-white/[0.5] pb-1 hover:text-gray-300 transition-colors">{t('footer.refundPolicy')}</Link></li>
              <li><Link href={getLocalizedPath('/data-deletion')} className="text-white inline-flex items-center text-sm font-medium leading-none border-b border-dotted border-white/[0.5] pb-1 hover:text-gray-300 transition-colors">{t('footer.dataDeletion')}</Link></li>
              <li><Link href={getLocalizedPath('/privacy')} className="text-white inline-flex items-center text-sm font-medium leading-none border-b border-dotted border-white/[0.5] pb-1 hover:text-gray-300 transition-colors">{t('footer.privacyPolicy')}</Link></li>
              <li><Link href={getLocalizedPath('/terms')} className="text-white inline-flex items-center text-sm font-medium leading-none border-b border-dotted border-white/[0.5] pb-1 hover:text-gray-300 transition-colors">{t('footer.termsOfService')}</Link></li>
            </ul>
          </div>
        </div>
